...
$ git clone -b F#SRC-3432_integrating_with_combined_robotHW_clean https://github.com/shadow-robot/Universal_Robots_ROS_Driver.git src/Universal_Robots_ROS_Driver
